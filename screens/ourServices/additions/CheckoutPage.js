...
const CheckoutPage=({navigation})=>{
    ...
    return(
        ...
        <ScrollView contentContainerStyle={{backgroundColor:'white',paddingTop:60,borderColor:'gray'}}>
            ...
            <View style={{marginBottom:25}}><Button title="Check out" onPress={()=>{navigation.navigate('BookingConfirmed',{orderId:'GISo7OmXnp59'})}} buttonStyle={{backgroundColor:'#F55633',width:304,height:50,alignSelf:'center',borderRadius:8}}/></View>
